...
class Edrone():
	...
	def __init__(self):
		...
		self.setpoint = [-7.96, 1.052, 26.507] # whycon marker at the position of the dummy given in the scene. Make the whycon marker associated with position_to_hold dummy renderable and make changes accordingly
